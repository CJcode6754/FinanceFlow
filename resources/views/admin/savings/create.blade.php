            ...
            <form action="{{ route('savings.store') }}" method="POST" class="space-y-5">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name"
                        class="w-full px-4 py-3 border rounded-lg text-sm dark:bg-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('name') border-red-400 @enderror"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="target_amount" id="target_amount"
                        class="w-full px-4 py-3 border rounded-lg text-sm dark:bg-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('target_amount') border-red-400 @enderror"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="current_amount" id="current_amount"
                        class="w-full px-4 py-3 border rounded-lg text-sm dark:bg-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('current_amount') border-red-400 @enderror"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="note" id="note"
                        class="w-full px-4 py-3 border rounded-lg text-sm dark:bg-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('note') border-red-400 @enderror"
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="deadline" id="deadline" value="{{ old('deadline') }}"
                        class="w-full px-4 py-3 border rounded-lg text-sm dark:bg-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('deadline') border-red-400 @enderror">
                    @error('deadline')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
