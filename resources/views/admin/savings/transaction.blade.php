<x-app-layout title="Savings Transaction">
    ...
    <div class="flex-1 md:ml-64">
        ...
        <main class="w-full px-8 py-6 mx-auto mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg md:w-1/2 md:px-8">
            ...
            <form action="{{route('savings.transaction.store')}}" method="POST" class="space-y-5">
                ...
                <div class="mb-4">
                    ...
                    <select id="transactionDropdown" name="transaction"
                        class="w-full px-4 py-3 text-sm text-gray-700 border border-gray-300 dark:bg-gray-700 dark:text-gray-300 rounded-lg focus:outline-none focus:ring-emerald-500">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="date" id="date" value="{{ old('date') }}"
                        class="w-full px-4 py-3 border rounded-lg text-sm focus:outline-none dark:bg-gray-700 dark:text-gray-300 focus:ring-2 focus:ring-emerald-500 @error('date') border-red-400 @enderror">
                    @error('date')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
