            ...
            <form action="{{route('savings.transaction.store')}}" method="POST" class="space-y-5">
                ...
                <div class="mb-4">
                    ...
                    <select id="transactionDropdown" name="transaction"
                        class="w-full px-4 py-3 text-sm text-gray-700 border border-gray-300 dark:bg-gray-700 dark:text-gray-300 rounded-lg focus:outline-none focus:ring-blue-500">
