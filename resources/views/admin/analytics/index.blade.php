                ...
                <div class="mx-auto space-y-6 max-w-7xl">
                    ...
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-gray-600 dark:text-gray-300">Track your financial performance and insights</p>
                        </div>

                        <div class="flex flex-col gap-3 sm:flex-row">
                            <select class="w-full px-3 py-2 text-sm bg-white border border-gray-300 rounded-md dark:bg-gray-700 dark:hover:bg-gray-600 md:w-48">
