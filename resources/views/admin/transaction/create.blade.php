            ...
            <form action="{{ route('transaction.store') }}" method="POST" class="space-y-5">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="note" id="note"
                        class="w-full px-4 py-3 border rounded-lg text-sm focus:outline-none focus:ring-2 dark:bg-gray-700 dark:text-gray-300 focus:ring-blue-500 @error('note') border-red-400 @enderror"
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="date" id="date" value="{{ old('date') }}"
                        class="w-full px-4 py-3 border rounded-lg text-sm focus:outline-none focus:ring-2 dark:bg-gray-700 dark:text-gray-300 focus:ring-blue-500 @error('date') border-red-400 @enderror">
