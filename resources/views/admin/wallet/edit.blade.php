            ...
            <form action="{{ route('wallet.update', $wallet->id) }}" method="POST" class="space-y-5">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="balance" id="balance"
                        class="w-full px-4 py-3 border rounded-lg text-sm focus:outline-none dark:bg-gray-700  focus:ring-2 focus:ring-emerald-500 @error('balance') border-red-400 @enderror"
