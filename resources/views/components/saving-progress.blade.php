        ...
        <div class="p-6 bg-gray-50 dark:bg-gray-700 rounded-xl">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-300">{{ number_format($saving->target_amount - $saving->current_amount, 2) }} remaining</p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format($saving->process_percent, 2) }}%</p>
            ...
            <div class="space-y-2">
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-gray-900 dark:text-gray-300">₱{{number_format($saving->current_amount, 2)}}</span>
                </div>
                ...
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-gray-900 dark:text-gray-300">₱{{number_format($saving->target_amount, 2)}}</span>
                </div>
            </div>
        </div>
    @endforeach
